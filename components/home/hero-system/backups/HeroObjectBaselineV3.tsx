/**
 * SAFETY SNAPSHOT — Hero Object Baseline V3
 * Frozen: 2026-08-04
 *
 * Preserves the production hero object visual implementation at the moment
 * before the hero-object-reframe study. Do not delete or overwrite.
 *
 * Production continues to use ../HomeHeroVisual.tsx.
 * Lab Baseline mode should prefer the live production component for exact parity;
 * this file is the recoverable snapshot of that object path.
 *
 * Companion frozen data copies in this folder:
 * - heroGeometryBaselineV3.ts
 * - heroDepthBaselineV3.ts
 * - heroEnvelopeBaselineV3.ts
 * - configBaselineV3.ts
 */
...
export default function HeroObjectBaselineV3({
