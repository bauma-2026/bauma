...
export default function MobileMenuToggle({ open, onToggle }: Props) {
  return (
    <button
      ...
      aria-expanded={open}
      onClick={onToggle}
      className="group relative inline-flex h-10 w-10 items-center justify-center rounded-full border border-neutral-200 bg-white transition-all duration-200 ease-out active:scale-95"
    >
      <span
        className={[
