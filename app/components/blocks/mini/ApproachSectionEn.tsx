const principles = [
  ...
  },
  {
    ...
    text: "Visuals, details and the feel of the page support understanding and trust.",
  },
];
      ...
      <div className="mx-auto grid max-w-[1100px] gap-10 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-start lg:gap-12 lg:px-8">
        <div>
          ...
          <p className="mt-5 max-w-[52ch] text-sm leading-6 text-white/55 sm:text-base sm:leading-7">
            First, I organize what the user needs to understand: remove noise,
            build the path and only then add form with a clear purpose.
          </p>
        </div>
