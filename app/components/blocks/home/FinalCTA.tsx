...
<section className="border-t border-white/10 bg-[#080808] py-20 text-white sm:py-24 lg:py-28">
  <div className="mx-auto max-w-[720px] px-6 text-center lg:px-8">
    ...
    <p className="mt-4 text-base leading-7 text-white/60">
      V nekaj minutah postane jasno, kje nastane zmeda — in zakaj uporabnik ne
      naredi naslednjega koraka.
    </p>

    <div className="mt-10 flex flex-col items-center gap-4">
      <a
        href="/contact"
        className="group relative inline-flex items-center justify-center overflow-hidden rounded-full border border-white bg-white px-5 py-3 text-sm font-medium text-black transition duration-300 hover:-translate-y-[1px] hover:bg-white/90"
      >
      ...
      <p className="text-xs text-white/40">
        Brez prodajnega calla · samo jasen naslednji korak
      </p>
    </div>
  </div>
</section>
